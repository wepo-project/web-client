...
<template>
  <div class="w-screen h-screen flex flex-col items-center justify-center py-2 px-4">
    <div class="flex w-full mb-3">
      ...
      <input v-model.trim="nick" type="text" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="elonmusk">
    </div>
    <div class="flex w-full mb-3">
