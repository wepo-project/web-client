...
<template>
    <div role="status"
    @animationend="onAniEnd"
    :class="state.close ? 'zoom-out' : 'zoom-in'"
    class="fixed top-1/2 left-1/2 -ml-6 -mt-6 w-12 h-12 rounded-full flex items-center justify-center text-center bg-white shadow-md">
        <svg aria-hidden="true" class="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-300 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
